        ...
        >
          ...
          <div className="bg-neutral-100 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 rounded-lg p-6">
            <p className="text-neutral-800 dark:text-neutral-200 leading-relaxed text-sm">
              <strong>PLEASE READ THESE TERMS CAREFULLY.</strong> By accessing or using Prediction-Engine, you agree to be bound by these Terms of Service and all applicable laws and regulations. These Terms constitute a legally binding agreement between you and Valyu.ai Ltd, a company registered in England and Wales (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). Prediction-Engine is a service operated by Valyu.ai Ltd. If you do not agree to these Terms, you must not access or use our Service. Your continued use of the Service following the posting of any changes to these Terms constitutes acceptance of those changes.
            </p>
          </div>
          ...
          <div className="space-y-12 text-neutral-900 dark:text-neutral-100">
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6">
              ...
              <p className="text-amber-800 dark:text-amber-200 leading-relaxed mb-4">
                <strong>Prediction-Engine provides AI-generated analysis for informational, educational, and research purposes only.</strong> Nothing on this platform constitutes, or should be construed as:
              </p>
            ...
            <section className="space-y-4">
              ...
              <p className="leading-relaxed text-neutral-700 dark:text-neutral-300 mb-4">
                By accessing or using Prediction-Engine (&ldquo;Service&rdquo; or &ldquo;Platform&rdquo;), a service operated by Valyu.ai Ltd (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;), you (&ldquo;User,&rdquo; &ldquo;you,&rdquo; or &ldquo;your&rdquo;)
            ...
            <section className="space-y-6">
              ...
              <p className="leading-relaxed text-neutral-700 dark:text-neutral-300">
                Prediction-Engine is an AI-powered research platform that provides deep analysis reports and probabilistic assessments
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <p className="text-blue-800 dark:text-blue-200 leading-relaxed">
                  <strong>Important:</strong> Prediction-Engine does not facilitate any betting, wagering, or financial transactions.
              ...
              <div className="bg-neutral-50 dark:bg-neutral-900/50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-neutral-700 dark:text-neutral-300">
                  ...
                  <li className="flex items-center">
                    ...
                    <span><Link href="/" className="text-blue-600 hover:text-blue-700 underline">prediction-engine.xyz</Link></span>
                  </li>
                </ul>
