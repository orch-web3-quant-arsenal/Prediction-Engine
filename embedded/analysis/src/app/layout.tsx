...
export const metadata: Metadata = {
  ...
  title: {
    default: "Prediction-Engine | AI-Powered Prediction Market Research",
    template: "%s | Prediction-Engine",
  },
  ...
  authors: [{ name: "Prediction-Engine", url: baseUrl }],
  creator: "Prediction-Engine",
  ...
  openGraph: {
    title: "Prediction-Engine | AI-Powered Prediction Market Research",
    description: "AI-powered deep research for prediction markets. Supports Polymarket and Kalshi.",
    url: baseUrl,
    siteName: "Prediction-Engine",
    images: [
      {
        url: "/og.png",
        width: 1200,
        height: 630,
        alt: "Prediction-Engine - AI-Powered Prediction Market Research",
      },
    ],
    locale: "en_US",
    type: "website",
