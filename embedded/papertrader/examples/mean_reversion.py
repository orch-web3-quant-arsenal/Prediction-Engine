...
Usage (live):
    pe-trader benchmark run examples.mean_reversion.run

Usage (backtest):
    from pe_trader.backtest import run_backtest, load_snapshots_csv
...
from pe_trader.models import NoPositionError, OrderRejectedError
