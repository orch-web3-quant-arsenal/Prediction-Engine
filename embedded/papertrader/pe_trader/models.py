"""Dataclasses and error types for pe-trader."""
...
class SimError(Exception):
    """Base error for all pe-trader errors."""
...
class NotInitializedError(SimError):
    ...
    def __init__(self, message: str = "Account not initialized. Run 'pe-trader init' first.") -> None:
        super().__init__(message)
