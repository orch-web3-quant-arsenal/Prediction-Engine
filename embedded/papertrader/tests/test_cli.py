...
from pe_trader.cli import main
from pe_trader.models import (
    Market,
    OrderBook,
    OrderBookLevel,
)
...
class TestTradingCommands:
    ...
    @patch("pe_trader.engine.PolymarketClient")
...
class TestMarketCommands:
    ...
    def test_markets_tags_error(self, MockClient, runner, data_dir):
        from pe_trader.models import ApiError
        _invoke(runner, ["init"], data_dir)
        mock_instance = MockClient.return_value
...
class TestResolveCommands:
    ...
    def test_resolve_specific_market_error(self, MockClient, runner, data_dir):
        from pe_trader.models import NoPositionError
        _invoke(runner, ["init"], data_dir)
        mock_instance = MockClient.return_value
...
class TestCliSimErrorPaths:
    ...
    @patch("pe_trader.engine.Engine.init_account")
    ...
    @patch("pe_trader.engine.Engine.reset")
    ...
    @patch("pe_trader.engine.Engine.get_pending_orders")
    ...
    @patch("pe_trader.engine.Engine.cancel_limit_order")
    ...
    @patch("pe_trader.engine.Engine.check_orders")
    ...
    @patch("pe_trader.engine.Engine.cancel_all_orders")
    ...
    @patch("pe_trader.benchmark.run_strategy")
    ...
    @patch("pe_trader.benchmark.compare_accounts")
    ...
    @patch("pe_trader.mcp_server.main")
