"""Behavior-driven tests for pe-trader.
...
from pe_trader.orderbook import simulate_buy_fill, simulate_sell_fill
from pe_trader.orders import create_order, get_order, get_pending_orders
...
class TestDefensiveGuards:
    ...
    def test_check_orders_no_fillable_liquidity(self, acct):
        ...
        from pe_trader.orderbook import FillResult
        ...
        with MagicMock() as mock_sim:
            import pe_trader.engine as engine_mod
