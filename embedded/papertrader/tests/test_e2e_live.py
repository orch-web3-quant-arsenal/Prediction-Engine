...
# Skip all tests in this module if PE_TRADER_LIVE env var is not set
...
def engine(tmp_path_factory) -> Engine:
    ...
    data_dir = tmp_path_factory.mktemp("pe-trader-e2e")
    eng = Engine(data_dir)
...
class TestFeeSimulation:
    ...
    def test_fee_formula_correctness(self, engine: Engine):
        ...
        from pe_trader.orderbook import calculate_fee
