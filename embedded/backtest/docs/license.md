...
| Scope | License | File |
|---|---|---|
| `prediction_market_extensions/` NautilusTrader extension package | LGPL-3.0-or-later | [`NOTICE`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/NOTICE), [`COPYING.LESSER`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/COPYING.LESSER), [`COPYING`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/COPYING) |
| Root files with a "Derived from NautilusTrader" or "Modified by Evan Kolberg" notice | LGPL-3.0-or-later | [`COPYING.LESSER`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/COPYING.LESSER), [`COPYING`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/COPYING) |
| Everything else such as `main.py`, `Makefile`, docs, and repo metadata | MIT | [`LICENSE-MIT`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/LICENSE-MIT) |

The full LGPL and GPL texts are in
[`COPYING.LESSER`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/COPYING.LESSER)
and [`COPYING`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/COPYING).
The [`NOTICE`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/NOTICE) file lists every
...
[`NOTICE`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/NOTICE).
...
- forking or redistributing: keep the LGPL license files, the
  [`NOTICE`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/NOTICE), and the per-file modification headers intact
...
Use [`LICENSE`](https://github.com/Archsec-Emman/Prediction-Engine/blob/v2/LICENSE)
